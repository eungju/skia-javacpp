...
public class gmmain {
    ...
    static class Iter {
        public static final List<GMRegistry.Factory> gms = Arrays.<GMRegistry.Factory>asList(
                aaclip.MyFactory,
                aarectmodes.MyFactory,
                arithmode.MyFactory,
                bigmatrix.MyFactory,
                bitmapcopy.MyFactory,
                bitmapfilters.MyFactory,
                bitmapscroll.MyFactory,
                blurs.MyFactory,
                colormatrix.MyFactory,
                complexclip.gFact0,
                complexclip.gFact1,
                complexclip2.MyFactory,
                ...
                emptypath.MyFactory,
                filltypes.MyFactory,
                filltypespersp.MyFactory,
                fontscaler.MyFactory,
                //TODO: gammatext. Mac specific code get in the way
                giantbitmap.G000,
                giantbitmap.G100,
                giantbitmap.G200,
                giantbitmap.G010,
                ...
                giantbitmap.G211,
                gradients.MyFactory,
                gradients.MyFactory2,
                gradients.MyFactory3,
                gradients.MyFactory4,
                gradtext.MyFactory,
                hairmodes.MyFactory,
                imageblur.MyFactory,
                //TODO: imagefiltersbase. Inheritance get in the way.
                lcdtext.MyFactory,
                linepaths.LinePathFactory,
                linepaths.LineClosePathFactory,
                morphology.MyFactory,
                //TODO: ninepatchstretch. GPU get in the way.
                nocolorbleed.MyFactory,
                patheffects.PathEffectFactory,
                pathfill.MyFactory,
                pathreverse.MyFactory,
                points.MyFactory,
                poly2poly.MyFactory,
                quadpaths.QuadPathFactory,
                quadpaths.QuadClosePathFactory,
                ...
                strokes.MyFactory,
                strokes.MyFactory2,
                tablecolorfilter.MyFactory,
                testimagefilters.MyFactory,
                //TODO: texdata. GPU get in the way.
                tilemodes.MyFactory,
                tinybitmap.MyFactory,
                verttext.MyFactory,
                verttext2.MyFactory,
                xfermodes.MyFactory
        );
