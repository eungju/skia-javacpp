...
public class cubicpaths {
    public static class CubicPathGM extends GM {
        @Override
        ...
        protected void onDraw(SkCanvas canvas) {
            ...
            final String title = "Cubic Drawn Into Rectangle Clips With " +
    ...
    public static class CubicClosePathGM extends GM {
        @Override
        protected String onShortName() {
            return "cubicclosepath";
        }
        ...
        protected void onDraw(SkCanvas canvas) {
            ...
            titlePaint.setLCDRenderText(true);
            titlePaint.setTextSize(15 * SK_Scalar1);
            final String title = "Cubic Closed Drawn Into Rectangle Clips With " +
            "Indicated Style, Fill and Linecaps, with stroke width 10";
            canvas.drawText(title,
                    20 * SK_Scalar1,
                    20 * SK_Scalar1,
    ...
    public static GMRegistry.Factory CubicPathFactory = new GMRegistry.Factory() {
        public GM apply() {
            return new CubicPathGM();
        }
    };

    public static GMRegistry.Factory CubicClosePathFactory = new GMRegistry.Factory() {
        public GM apply() {
