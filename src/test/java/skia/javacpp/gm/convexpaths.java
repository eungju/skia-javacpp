...
public class convexpaths {
    static class SkOnce {
        public SkOnce() { fDidOnce = false; }

        public boolean needToDo() { return !fDidOnce; }
        public boolean alreadyDone() { return fDidOnce; }
        public void accomplished() {
            SkASSERT(!fDidOnce);
            fDidOnce = true;
        }

        private boolean fDidOnce;
    };

    public static class ConvexPathsGM extends GM {
        SkOnce fOnce = new SkOnce();
        ...
        void makePaths() {
            ...
            // CW
            fPaths.add(new SkPath());fPaths.getLast().moveTo(0, 0);
            ...
            // CW
            fPaths.add(new SkPath());fPaths.getLast().moveTo(0, 50 * SK_Scalar1);
            ...
            fPaths.add(new SkPath());fPaths.getLast().addRect(0, 0,
            ...
            fPaths.add(new SkPath());fPaths.getLast().addCircle(50  * SK_Scalar1, 50  * SK_Scalar1,
                    50  * SK_Scalar1, SkPath.kCW_Direction);

            fPaths.add(new SkPath());fPaths.getLast().addCircle(50  * SK_Scalar1, 50  * SK_Scalar1,
                    40  * SK_Scalar1, SkPath.kCCW_Direction);

            fPaths.add(new SkPath());fPaths.getLast().addOval(SkRect.MakeXYWH(0, 0,
                    50 * SK_Scalar1,
                    100 * SK_Scalar1),
                    SkPath.kCW_Direction);
            ...
            fPaths.add(new SkPath());fPaths.getLast().addRoundRect(SkRect.MakeXYWH(0, 0,
                    SK_Scalar1 * 100,
                    SK_Scalar1 * 100),
            ...
            // shallow diagonals
            fPaths.add(new SkPath());fPaths.getLast().lineTo(100 * SK_Scalar1, SK_Scalar1);
            ...
            */
            ...
            // cubics
            fPaths.add(new SkPath());fPaths.getLast().cubicTo( 1 * SK_Scalar1,  1 * SK_Scalar1,
                    10 * SK_Scalar1,  90 * SK_Scalar1,
                    0 * SK_Scalar1, 100 * SK_Scalar1);
            fPaths.add(new SkPath());fPaths.getLast().cubicTo(100 * SK_Scalar1,  50 * SK_Scalar1,
                    20 * SK_Scalar1, 100 * SK_Scalar1,
                    0 * SK_Scalar1,   0 * SK_Scalar1);

            // triangle where one edge is a degenerate quad
            fPaths.add(new SkPath());fPaths.getLast().moveTo(SkFloatToScalar(8.59375f), 45 * SK_Scalar1);
            ...
            // point degenerate
            fPaths.add(new SkPath());fPaths.getLast().moveTo(50 * SK_Scalar1, 50 * SK_Scalar1);
            ...
            // line degenerate
            fPaths.add(new SkPath());fPaths.getLast().lineTo(100 * SK_Scalar1, 100 * SK_Scalar1);
            fPaths.add(new SkPath());fPaths.getLast().quadTo(100 * SK_Scalar1, 100 * SK_Scalar1, 0, 0);
            fPaths.add(new SkPath());fPaths.getLast().quadTo(100 * SK_Scalar1, 100 * SK_Scalar1,
                    50 * SK_Scalar1, 50 * SK_Scalar1);
            fPaths.add(new SkPath());fPaths.getLast().quadTo(50 * SK_Scalar1, 50 * SK_Scalar1,
                    100 * SK_Scalar1, 100 * SK_Scalar1);
            fPaths.add(new SkPath());fPaths.getLast().cubicTo(0, 0,
                    0, 0,
                    100 * SK_Scalar1, 100 * SK_Scalar1);

            // small circle. This is listed last so that it has device coords far
            // from the origin (small area relative to x,y values).
            fPaths.add(new SkPath());fPaths.getLast().addCircle(0, 0, SkFloatToScalar(0.8f));
        }
