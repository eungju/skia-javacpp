...
public class linepaths {
    public static class LinePathGM extends GM {
        @Override
        ...
        protected void onDraw(SkCanvas canvas) {
            ...
            String title = "Line Drawn Into Rectangle Clips With " +
    ...
    public static class LineClosePathGM extends GM {
        @Override
        protected String onShortName() {
            return "lineclosepath";
        }
        ...
        protected void onDraw(SkCanvas canvas) {
            ...
            titlePaint.setLCDRenderText(true);
            titlePaint.setTextSize(15 * SK_Scalar1);
            String title = "Line Closed Drawn Into Rectangle Clips With " +
            "Indicated Style, Fill and Linecaps, with stroke width 10";
            canvas.drawText(title,
                    20 * SK_Scalar1,
                    20 * SK_Scalar1,
    ...
    public static GMRegistry.Factory LinePathFactory = new GMRegistry.Factory() {
        public GM apply() {
            return new LinePathGM();
        }
    };

    public static GMRegistry.Factory LineClosePathFactory = new GMRegistry.Factory() {
        public GM apply() {
            return new LineClosePathGM();
        }
    };
}
