...
public class quadpaths {
    public static class QuadPathGM extends GM {
        @Override
    ...
    public static class QuadClosePathGM extends GM {
        @Override
        protected String onShortName() {
            return "quadclosepath";
        }
        ...
        protected void onDraw(SkCanvas canvas) {
            ...
            titlePaint.setLCDRenderText(true);
            titlePaint.setTextSize(15 * SK_Scalar1);
            String title = "Quad Closed Drawn Into Rectangle Clips With " +
            "Indicated Style, Fill and Linecaps, with stroke width 10";
            canvas.drawText(title,
                    20 * SK_Scalar1,
                    20 * SK_Scalar1,
    ...
    public static GMRegistry.Factory QuadPathFactory = new GMRegistry.Factory() {
        public GM apply() {
            return new QuadPathGM();
        }
    };

    public static GMRegistry.Factory QuadClosePathFactory = new GMRegistry.Factory() {
        public GM apply() {
